...
try {
  ...
  var path_toilet = __dirname+'/cache/mach.png'; 
  var id = Object.keys(event.mentions)[0] || event.senderID;
  const canvas = Canvas.createCanvas(500, 670);
	const ctx = canvas.getContext('2d');
	const background = await Canvas.loadImage('https://imgur.com/0lXoEif.png');
	...
	ctx.drawImage(await Canvas.loadImage(avatar), 200, 75, 150, 150);
