module.exports.config = {
	...
	version: "1.0.0",
	hasPermssion: 0,
	credits: "Siêu Đáng Yêu", //FIXED BY KOJIRO
...
//File download function is available including font or rankcard (can be changed)
  ...
  if (!existsSync(resolve(__dirname, 'cache', 'rankcard1.png'))) await downloadFile("https://imgur.com/cD7W8yS.png", resolve(__dirname, 'cache', 'rankcard1.png", resolve(__dirname, 'cache', 'rankcard10.png'));
