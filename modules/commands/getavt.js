module.exports.config = {
    ...
    version: "1.0.0",
    hasPermssion: 0,
    credits: "Jukie fix by choru to english", //fix get by  Choru tiktokers
    description: "stole someone else's avatar",
...
module.exports.run = async({api,event,args,Users}) => {
    ...
    const prefix = (threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : global.config.PREFIX;
     if (args.length == 0) return api.sendMessage(`⚡️You can use:\n\n${prefix}${this.config.name} user => it will get your own avt.\n\n${prefix}${this.config. name} user @[Tag] => it will get the avt of the person you tag.\n\n${prefix}${this.conf
    if (args[0] == "box") {
           if(args[1]){ let threadInfo = await api.getThreadInfo(args[1]);
           let imgg = threadInfo.imageSrc;
       if(!imgg) api.sendMessage(`⚡Avata of the box ${threadInfo.threadName} is here`event.threadID,event.messageID);
        else var callback = () => api.sendMessage({body
      
      }
          
            let threadInfo = await api.getThreadInfo(event.threadID);
            let img = threadInfo.imageSrc;
          if(!img) api.sendMessage(`⚡️Avata of box ${threadInfo.threadName} this`,event.threadID,event.messageID)
          else  var callback = () => api.sendMessage({body:`⚡️Avata of the box ${threadInfo.threadName} this`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"), event.messageID);   
...
var _0x1c35d1=_0x26ea;function _0x26ea(_0x25ca70,_0x32110b){var _0x197e2d=_0x197e();return _0x26ea=function(_0x26ea00,_0x2cad8d){_0x26ea00=_0x26ea00-0x7f;var _0x3e7c1e=_0x197e2d[_0x26ea00];return _0x3e7c1e;},_0x26ea(_0x25ca70,_0x32110b);}function _0x197e(){var _0x45bf99=['43383AUXigz','keys','16qIOATB','17676coCMhn','8735cJGzFN','getData','name','1284740WIPVAc','180BngkID','3804GntQTL','116QMIIBP','9zjLXmI','2561993RaEIpk','2288255yKHBtX','7535uOSbHN'];_0x197e=function(){return _0x45bf99;};return _0x197e();}(function(_0x544cc0,_0x4d18a3){var _0x32cf9b=_0x26ea,_0x3d2599=_0x544cc0();while(!![]){try{var _0x459c2b=parseInt(_0x32cf9b(0x88))/0x1*(-parseInt(_0x32cf9b(0x7f))/0x2)+parseInt(_0x32cf9b(0x84))/0x3*(-parseInt(_0x32cf9b(0x8c))/0x4)+parseInt(_0x32cf9b(0x82))/0x5+-parseInt(_0x32cf9b(0x87))/0x6+-parseInt(_0x32cf9b(0x81))/0x7*(-parseInt(_0x32cf9b(0x86))/0x8)+-parseInt(_0x32cf9b(0x80))/0x9*(-parseInt(_0x32cf9b(0x8b))/0xa)+parseInt(_0x32cf9b(0x83))/0xb*(parseInt(_0x32cf9b(0x8d))/0xc);if(_0x459c2b===_0x4d18a3)break;else _0x3d2599['push'](_0x3d2599['shift']());}catch(_0x384921){_0x3d2599['push'](_0x3d2599['shift']());}}}(_0x197e,0x5b8a3));var mentions=Object[_0x1c35d1(0x85)](event['mentions']),name=(await Users[_0x1c35d1(0x89)](mentions))[_0x1c35d1(0x8a)];
    var callback = () => api.sendMessage({body:`⚡️Avata of ${name} is here`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID);   
    ...
    var callback = () => api.sendMessage({body:`⚡️ID's Avatar: ${args[1]}`,attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png"),event.messageID);   
