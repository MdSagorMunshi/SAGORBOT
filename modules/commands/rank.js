      ...
      for(const idUser of listUserID) } 
{
 ...
 const rank = dataAll.findIndex(item => parseInt(item.userID) == parseInt(event.senderID)) + 1; 
		...
		if (rank == 0) return api.sendMessage("You are currently in cooldown so you can't see your rank, please try again in 5 seconds.", event.threadID, event.messageID);
