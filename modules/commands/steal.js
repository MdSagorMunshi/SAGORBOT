module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Mirai Team",
	description: "steal money you may win or lose use at your own risk",
	commandCategory: "Stealing",
	usages: "",
	cooldowns: 5
};
...
module.exports.run = async function({ api, event, Users, Currencies }) {
    ...
    const moneydb = (await Currencies.getData(victim)).money;
       var money = Math.floor(Math.random() * 999999991000) + 1;
        ...
        var moneyuser = (await Currencies.getData(event.senderID)).money
            if (moneyuser <= 0) return api.sendMessage("You don't have money, WORK Or Claim Daily TO GET SOME MONEY..", event.threadID, event.messageID);
